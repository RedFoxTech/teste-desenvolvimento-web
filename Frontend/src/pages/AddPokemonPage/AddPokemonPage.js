            ...
            await API.post(`/pokemon`, {
                ...
                .then((response) => {
                    if (response.status === 201 && response.statusText === "Created") {
                        handleClickOpen();
                        setHasError(false);
                        setFeedbackTitle('Pokémon cadastrado com sucesso');
                        setFeedbackMessage('Seu pokémon foi cadastrado com sucesso. Basta acessa-lo para gerenciar.');
                    } else {
                        handleClickOpen();
                        setHasError(true);
                        setFeedbackTitle('Erro ao cadastrar Pokémon');
                            ...
                            <Grid item xs={3}>
                                <Paper className={classes.paper}>
                                    ...
                                    <TextField
                                        ...
                                        value={atk}
                                        //onClick={atk === 0 ? (() => setAtk('')) : (() => setAtk(atk))}
                                        onClick={() => setAtk('')}
                                    />
                                </Paper>
                            </Grid>
