...
function Edit(){
  ...
  useEffect(()=>{
    api.get(`/pokemons/${id}`).then(response => {
      ...
      setImg_name(response.data.pokedex_number);
      ...
      setFamily_id(response.data.family_id);
      setCross_gen(response.data.cross_gen);
      setType_one(response.data.type_one);
      setType_two(response.data.type_two);
      setWeather_one(response.data.weather_one);
      setWeather_two(response.data.weather_two);
      ...
      setIs_new(response.data.is_new);
      setNot_gettable(response.data.not_gettable);
      setFuture_evolve(response.data.future_evolve);
      setCp_100_40(response.data.cp_100_40);
      setCp_100_39(response.data.cp_100_39);
    }, error => {
