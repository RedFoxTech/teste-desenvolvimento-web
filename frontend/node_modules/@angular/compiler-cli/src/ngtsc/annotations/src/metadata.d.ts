 ...
 */
export declare function generateSetClassMetadataCall(clazz: DeclarationNode, reflection: ReflectionHost, isCore: boolean, annotateForClosureCompiler?: boolean): Statement | null;
