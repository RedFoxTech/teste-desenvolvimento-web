...
function(t, e, n, r, i, o, s, u) {
    ...
    function t(t) {
        ...
        /**
             ...
             * outstanding.
             */
        this.cc = 0, this.forceRefresh = !1, this.auth = null, this.asyncQueue = null, this.ac = function() {
            e.cc++, e.currentUser = e.uc(), e.oc.resolve(), e.changeListener && e.asyncQueue.enqueueRetryable((function() {
                return e.changeListener(e.currentUser);
            }));
        };
        var n = function(t) {
            V("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.auth.addAuthTokenListener(e.ac);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
...
}), "PUBLIC" /* PUBLIC */)), c("@firebase/firestore", "2.3.7", undefined);
