 ...
 */ function D(t) {
    ...
    if (N.logLevel <= c.DEBUG) {
        var r = e.map(C);
        N.debug.apply(N, E([ "Firestore (8.6.8): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (N.logLevel <= c.ERROR) {
        var r = e.map(C);
        N.error.apply(N, E([ "Firestore (8.6.8): " + t ], r));
    }
}
...
function R(t) {
    ...
    if (N.logLevel <= c.WARN) {
        var r = e.map(C);
        N.warn.apply(N, E([ "Firestore (8.6.8): " + t ], r));
    }
}
...
}(K), z = /^[_a-zA-Z][_a-zA-Z0-9]*$/, W = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return w(e, t), e.prototype.construct = function(t, n, r) {
...
var Dt = /** @class */ function(t) {
     ...
     */    return w(e, t), e.create = function(t, n, r) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.l(t, n, r) : new kt(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Ot(t, r) : "in" /* IN */ === n ? new Ft(t, r) : "not-in" /* NOT_IN */ === n ? new Pt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Vt(t, r) : new e(t, n, r);
    }, e.l = function(t, e, n) {
...
/** A mutation that deletes the document at the given key. */ var Pe, Ve, Me = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
 ...
 */
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (Qt(e) || zt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (S() <= c.DEBUG && D("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ee(e)), 
...
function cr(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(s) {
            switch (s.label) {
              case 0:
                return n = F(t), r = n._n, i = n.Mn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
...
function vr(t, e, n) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(u) {
            switch (u.label) {
              case 0:
                r = F(t), i = r.Fn.get(e), o = n ? "readwrite" : "readwrite-primary", u.label = 1;
 ...
 */ function gr(t, e, n, r) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = F(t), o = tn(), s = He(), u = Ze(), a = 0, c = n; a < c.length; a++) h = c[a], 
              ...
              case 1:
                ...
                return d = p.sent(), [ 2 /*return*/ , i.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return dr(t, f, s, x.min(), u).next((function(e) {
                        return f.apply(t), e;
                    })).next((function(e) {
    ...
    return void 0 === n && (n = tn()), b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(o) {
            switch (o.label) {
              ...
              case 1:
                return r = o.sent(), [ 2 /*return*/ , (i = F(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    var o = wn(e.readTime);
    ...
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(s) {
            switch (s.label) {
              ...
              case 6:
                if (e instanceof sn ? t.qr.X(e) : e instanceof un ? t.qr.rt(e) : t.qr.et(e), n.isEqual(x.min())) return [ 3 /*break*/ , 13 ];
                s.label = 7;
...
function ai(t) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(s) {
            switch (s.label) {
              case 0:
                e = F(t), n = mi(e), r = e.kr.length > 0 ? e.kr[e.kr.length - 1].batchId : -1, s.label = 1;
                ...
                return e && mi(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return b(this, void 0, void 0, (function() {
                        ...
                        return _(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return xe(r = e.code) && r !== I.ABORTED ? (n = t.kr.shift(), 
 ...
 */ function yi(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = F(t), e ? (n.Or.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Wr(n) ]) : [ 3 /*break*/ , 2 ];
 ...
 */ function Ai(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = F(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new Ti), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
...
function Ni(t, e) {
    return b(this, void 0, void 0, (function() {
        var n, r, i, o, s;
        return _(this, (function(u) {
            return n = F(t), r = e.query, i = !1, (o = n.queries.get(r)) && (s = o.listeners.indexOf(e)) >= 0 && (o.listeners.splice(s, 1), 
...
/** Stops listening to the query. */ function Gi(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(o) {
            switch (o.label) {
              case 0:
                return n = F(t), r = n.Po.get(e), (i = n.Vo.get(r.targetId)).length > 1 ? [ 2 /*return*/ , (n.Vo.set(r.targetId, i.filter((function(t) {
                    return !$t(t, e);
    ...
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(c) {
            switch (c.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (r = F(t)).sharedClientState.updateQueryState(e, "rejected", n), i = r.Co.get(e), 
                (o = i && i.key) ? (s = (s = new je(ot.comparator)).insert(o, Et.newNoDocument(o, x.min())), 
                u = tn().add(o), a = new rn(x.min(), 
...
function Hi(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(o) {
            switch (o.label) {
              case 0:
                n = F(t), r = e.batch.batchId, o.label = 1;
 ...
 */ function Xi(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(u) {
            switch (u.label) {
              case 0:
                ei((n = F(t)).remoteStore) || D("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                u.label = 1;
...
function io(t, e, n) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(u) {
            switch (u.label) {
              case 0:
                return r = F(t), i = [], o = [], s = [], r.Po.isEmpty() ? [ 3 /*break*/ , 3 ] : (r.Po.forEach((function(t, u) {
...
function oo(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(i) {
            switch (i.label) {
              case 0:
                return (n = F(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (D("SyncEngine", "User change. New user:", e.toKey()), 
        ...
        return b(this, void 0, void 0, (function() {
            ...
            return _(this, (function(c) {
                switch (c.label) {
                  ...
                  case 4:
                    return n._updateProgress(Fi(r)), i = new Oi(r, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return zi(n.syncEngine, t, 1 /* SharedClientState */);
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return b(this, void 0, void 0, (function() {
                            ...
                            return _(this, (function(a) {
                                switch (a.label) {
                                  case 0:
                                    return n = F(t), r = An(n.R) + "/documents", i = {
                    ...
                    return function(t, e) {
                        return b(this, void 0, void 0, (function() {
                            ...
                            return _(this, (function(i) {
                                switch (i.label) {
                                  case 0:
                                    return (n = F(t)).asyncQueue.verifyOperationInProgress(), D("RemoteStore", "RemoteStore received new credentials"), 
                                    r = ei(n), 
                                  ...
                                  case 2:
                                    return i.sent(), n.Or.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Wr(n) ];
 ...
 */ function Xo(t, e) {
    ...
    if (t = s(t), Mo("collection", "path", e), t instanceof zo) return Bo(n = Q.fromString.apply(Q, E([ e ], r))), 
 ...
 */ function Jo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = V.u()), Mo("doc", "path", e), t instanceof zo) return xo(n = Q.fromString.apply(Q, E([ e ], r))), 
    new Wo(t, 
    /* converter= */ null, new ot(n));
    if (!(t instanceof Wo || t instanceof Yo)) throw new A(I.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return xo(n = t._path.child(Q.fromString.apply(Q, E([ e ], r)))), new Wo(t.firestore, t instanceof Yo ? t.converter : null, new ot(n));
}
 ...
 * Firestore database.
 */ function Zo(t, e) {
    return t = s(t), e = s(e), (t instanceof Wo || t instanceof Yo) && (e instanceof Wo || e instanceof Yo) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new js(t._firestore, t._userDataWriter, e.doc.key, e.doc, new xs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
 ...
 */ function lu(t) {
    ...
    if (t instanceof Wo) h = Go(t.firestore, is), l = Kt(t._key.path), c = {
        next: function(e) {
            i[a] && i[a](du(h, t, e));
        },
        error: i[a + 1],
...
var Nu = /** @class */ function() {
    ...
    return t.su = function(e, n, r) {
        ...
        return (t = s(t)) instanceof Wo && Zo(this._delegate, t);
    }, t.prototype.set = function(t, e) {
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return function(t, e) {
                ...
                return new Bs(e, r, t._key, n, new xs(null !== n && n.hasLocalMutations, 
...
var Ru = /** @class */ function() {
     ...
     */
        function(t) {
            ...
            return new Fu(e.firestore, new Gs(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Du(e), i = ku(e, (function(e) {
    ...
    return w(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Au.eu(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Lu);
...
export { hs as D, is as E, Nu as G, Tu as K, wu as L, q as O, Eu as Q, Cu as X, Ru as Y, Lu as Z, mu as a, xu as c, Fu as e, Mu as i, Iu as j, Pu as n, qu as o, rs as p, bu as q, Uu as r };
//# sourceMappingURL=prebuilt-4d572f93-ec5ec72d.js.map
