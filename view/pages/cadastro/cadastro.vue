  ...
  <div>
    ...
    <div class="container">
      <b-form @submit="onSubmit" @reset="onReset" v-if="show">
        ...
        <!-- cross gen -->
        <b-form-group id="input-group-3" label="Cross gen:" label-for="input-3">
          <b-form-select
            id="input-3"
        ...
        <!-- weather 1-->
        <b-form-group id="input-group-2" label="weather 1:" label-for="input-2">
          <b-form-input
            id="input-2"
        ...
        <!-- weather 2 -->
        <b-form-group id="input-group-2" label="weather 2:" label-for="input-2">
          <b-form-input
            id="input-2"
        ...
        <!-- Legendary -->
        <b-form-group id="input-group-3" label="Legendary:" label-for="input-3">
          <b-form-select
            id="input-3"
        ...
        <!-- hatchable -->
        <b-form-group id="input-group-2" label="Hatchable:" label-for="input-2">
          <b-form-input
            id="input-2"
...
export default {
  ...
  methods: {
    onSubmit(evt) {
      ...
      this.$http.post("pokemons/", this.form).then(
