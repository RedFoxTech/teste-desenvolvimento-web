...
function conversionRatio(units, desiredConversion) {
  ...
  !found ?  invariant(false, "No conversion ratio could be found for " + desiredConversion)  : void 0;
  return {
...
function _convert(quantity) {
  return {
    from: function from(_from) {
      ...
      !units ?  invariant(false, "No conversion could be found for " + _from)  : void 0;
