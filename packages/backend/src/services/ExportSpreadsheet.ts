 ...
 * @module packages/backend/services/exportSpreadsheet
 * @see {@link module:packages/backend/middlewares/WatchSpreadSheet}
 * @see {@link module:packages/backend/services/importSpreadsheet}
 * @todo implementar exportação para spreadsheet
 * @version 0.0.0
 * @since 01/08/2021
 */
